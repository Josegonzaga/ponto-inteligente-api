...
import com.eclodir.pontointeligente.api.dtos.CadastroPJDto;
...
public class CadastroPJController {
	...
	private void validarDadosExistentes(CadastroPJDto cadastroPJDto, BindingResult result) {
		...
		this.funcionarioService.buscarPorCpf(cadastroPJDto.getCpf()).ifPresent(func -> result.addError(new ObjectError("funcionario", "CPF já existe.")));
	...
	/**
	 * Converter os dados para empresa
	 * 
	 * @param cadastroPJDto
	 * @return
	 */
	...
	/**
	 * Converer os dados para funcionario.
	 * 
	 * @param cadastroPJDto
	 * @param result
	 * @return
